	...
	<%
		try{
			...
			for(String login : loginContas)
			{
				...
				String password = contaE.getPassword();//"pass1234#";
				String server_send_address = contaE.getServer_send_address();//"smtp.gmail.com";
				String server_receive_address = contaE.getServer_receive_address();//"imap.gmail.com";
				String server_send_protocol = contaE.getServer_send_protocol();//"SMTP";
				String server_receive_protocol = contaE.getServer_receive_protocol();//"POP3";
				int server_send_port = contaE.getServer_send_port();//465;
				int server_receive_port = contaE.getServer_receive_port();//993;
				String name_user = contaE.getNameUser();//"joao_ferreira";
